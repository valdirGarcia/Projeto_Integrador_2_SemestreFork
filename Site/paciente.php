    ...
    <div class="container bg-red-100">
          <div class="flex flex-row bg-white items-center">
            ...
            <div class="flex flex-row pl-5 items-center">
                <div class="flex justify-center items-center h-9 w-9 bg-white-400 border-solid border-4 border-blue-600 rounded-xl"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class=" w-6 h-6">
            ...
            <div class="flex flex-row pl-5 items-center mr-auto">
               ...
               <button class="app-color-blue-1 font-semibold text-md app-button-shadow w-40 py-2 rounded-3xl mr-5">Agendamento</button>
        ...
        <div class="flex flex-col app-bg-white-1 px-12 pb-10">
            ...
            <div class="flex flex-row">
                <div class="flex flex-col w-40 bg-white pl-5 py-3 mr-3 rounded-tl-2xl rounded-tr-2xl bg-white active">
                    <span class="text-3xl app-color-blue-1 font-bold">1</span>
                ...
                <table class="w-full">
                    <thead>
                        <tr>
                            <th></th>
                            <th></th>
                            <th class="text-left text-xs app-color-black">MEDICO</th>
                            ...
                            <td>
                                <div class="flex flex-row py-3">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="font-semibold text-sm app-color-black">Dr.Murilo Dollitle</span>
