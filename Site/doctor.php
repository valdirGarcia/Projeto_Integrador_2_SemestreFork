...
<body class="bg-gray-200 flex justify-center items-center h-screen w-screen">
    <div class="container bg-red-100">
          <div class="flex flex-row bg-white items-center">
            ...
            <section >
               <button href="cadastro.php" type="submit" value="cadastro" class="app-color-blue-1 font-semibold text-md app-button-shadow w-40 py-2 rounded-3xl mr-5">cadastro</button>  
                <a href="<?= $BASE_URL ?>logout.php" class="  app-color-red-1 font-semibold text-md app-button-shadow w-10 py-2 rounded-3xl mr-9">SAIR</a>
                </section>
